...
export const REWARD_PILL_DIVIDER_COLOR = '#fff7d5';
const OFFER_DURATION_DIVIDER_COLOR = REWARD_PILL_DIVIDER_COLOR;
export const REWARD_PILL_DIVIDER_WIDTH_PX = OFFER_DURATION_DIVIDER_WIDTH_PX;
export const REWARD_PILL_DIVIDER_HEIGHT_PX = OFFER_DURATION_DIVIDER_HEIGHT_PX;
