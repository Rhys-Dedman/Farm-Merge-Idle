...
export const StoreScreen: React.FC<StoreScreenProps> = ({ onAddMoney }) => {
  return (
    <div className="h-full w-full flex flex-col items-center p-6 space-y-8 overflow-y-auto no-scrollbar pt-24">
