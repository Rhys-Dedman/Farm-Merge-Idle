...
export const SFX_IDS = {
  ...
  keyBurst: 'sfx_key_burst',
  keyImpact: 'sfx_key_impact',
  specialDeliveryUnlock: 'sfx_specialdelivery_unlock',
  specialDeliveryDoorOpen: 'sfx_specialdelivery_dooropen',
  specialDeliveryDoorOpenSpecial: 'sfx_specialdelivery_dooropenspecial',
  specialDeliveryNoKeys: 'sfx_specialdelivery_nokeys',
  specialDeliveryDoorClose: 'sfx_specialdelivery_doorclose',
  specialDeliveryRewardReveal: 'sfx_specialdelivery_rewardreveal',
  specialDeliveryRewardClaimNormal: 'sfx_specialdelivery_rewardclaimnormal',
  specialDeliveryRewardClaimTrophy: 'sfx_specialdelivery_rewardclaimtrophy',
...
const SFX_PATHS: Record<SfxId, string> = {
  ...
  [SFX_IDS.keyBurst]: '/assets/sfx/sfx_key_burst.wav',
  [SFX_IDS.keyImpact]: '/assets/sfx/sfx_key_impact.wav',
  [SFX_IDS.specialDeliveryUnlock]: '/assets/sfx/sfx_specialdelivery_unlock.wav',
  [SFX_IDS.specialDeliveryDoorOpen]: '/assets/sfx/sfx_specialdelivery_dooropen.mp3',
  [SFX_IDS.specialDeliveryDoorOpenSpecial]: '/assets/sfx/sfx_specialdelivery_dooropenspecial.mp3',
  [SFX_IDS.specialDeliveryNoKeys]: '/assets/sfx/sfx_specialdelivery_nokeys.mp3',
  [SFX_IDS.specialDeliveryDoorClose]: '/assets/sfx/sfx_specialdelivery_doorclose.wav',
  [SFX_IDS.specialDeliveryRewardReveal]: '/assets/sfx/sfx_specialdelivery_rewardreveal.wav',
  [SFX_IDS.specialDeliveryRewardClaimNormal]: '/assets/sfx/sfx_specialdelivery_rewardclaimnormal.wav',
  [SFX_IDS.specialDeliveryRewardClaimTrophy]: '/assets/sfx/sfx_specialdelivery_rewardclaimtrophy.wav',
